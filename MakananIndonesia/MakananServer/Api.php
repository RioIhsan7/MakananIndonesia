...
$asal = $this->input->post('asal_makanan');
$harga = $this->input->post('harga_makanan');

$this->db->where('nama_makanan', $nama);
...
$simpan['nama_makanan'] = $nama;
$simpan['asal_makanan'] = $asal;
$simpan['harga_makanan'] = $harga;

$status = $this->db->insert('tb_makanan',$simpan);
